...
class DRLAgent:
    ...
    def DRL_prediction(model, test_data, test_env, test_obs):
        ...
        transaction_cost_memory = test_env.env_method(method_name="save_transaction_cost_memory")  # New line
        end = time.time()
        return account_memory[0], actions_memory[0], transaction_cost_memory[0]
